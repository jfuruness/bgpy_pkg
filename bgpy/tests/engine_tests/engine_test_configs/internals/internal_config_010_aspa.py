...
as_graph_info = ASGraphInfo(
    ...
    customer_provider_links=frozenset(
        [
            ...
            CPLink(provider_asn=1000, customer_asn=8),  # Replaced ASNs.REFLECTOR with 1000
            CPLink(provider_asn=1000, customer_asn=9),  # Replaced ASNs.REFLECTOR with 1000
            CPLink(provider_asn=1000, customer_asn=10), # Replaced ASNs.REFLECTOR with 1000
...
internal_config_010_aspa = EngineTestConfig(
    name="internal_config_010_aspa",
    desc=(
