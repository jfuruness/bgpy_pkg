...
class BGP(Policy):
    ...
    recv_q: Incomplete
    as_: Incomplete
    def __init__(self, local_rib: LocalRIB | None = None, recv_q: RecvQueue | None = None, as_: AS | None = None) -> None: ...
    def _get_best_ann_by_gao_rexford(self, current_ann: Ann | None, new_ann: Ann) -> Ann: ...
    ...
    def process_incoming_anns(self, *, from_rel: Relationships, propagation_round: int, scenario: Scenario, reset_q: bool = True) -> None: ...
    def _valid_ann(self, ann: Ann, recv_relationship: Relationships) -> bool: ...
    def _copy_and_process(self, ann: Ann, recv_relationship: Relationships, overwrite_default_kwargs: dict[Any, Any] | None = None) -> Ann: ...
    ...
    def _policy_propagate(self, neighbor: AS, ann: Ann, propagate_to: Relationships, send_rels: set[Relationships]) -> bool: ...
    def _prev_sent(self, neighbor: AS, ann: Ann) -> bool: ...
    def _process_outgoing_ann(self, neighbor: AS, ann: Ann, propagate_to: Relationships, send_rels: set[Relationships]) -> None: ...
    @property
