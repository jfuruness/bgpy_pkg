...
class Graph014(GraphInfo):
    r"""
    TODO: Add reference to image online (it's a bit much for pixel art)
    Mini internet test topology with attacker directly connected to 7.
    """
    def __init__(self):
        super(Graph014, self).__init__(
            peer_links=set([
                PeerLink(1, 2),
                PeerLink(2, 4),
                PeerLink(4, 3),
            ...
            customer_provider_links=set([
                ...
                CPLink(provider_asn=14, customer_asn=20),
