...
class Graph038(GraphInfo):
    ...
    def __init__(self):
        super(Graph038, self).__init__(
            peer_links=set([PeerLink(135, ASNs.VICTIM.value), PeerLink(34, ASNs.ATTACKER.value), PeerLink(12, 34), PeerLink(11, 33)]),
