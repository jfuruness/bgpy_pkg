...
def test_process_incoming_anns_bgp_relationships(BaseASCls):
    ...
    prefix = '137.99.0.0/16'
    ann1 = EasyAnn(prefix=prefix, as_path=(13794,),timestamp=0)
...
def test_process_incoming_anns_bgp_path_len(BaseASCls):
    ...
    prefix = '137.99.0.0/16'
    ann1 = EasyAnn(prefix=prefix, as_path=(2, 3, 13794),timestamp=0)
...
def test_process_incoming_anns_bgp_seeded(BaseASCls):
    ...
    prefix = '137.99.0.0/16'
    ann1 = EasyAnn(prefix=prefix, as_path=(1,),timestamp=0, seed_asn=1)
